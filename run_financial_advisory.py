#!/usr/bin/env python3
"""
Runner script for financial advisory use case.
"""
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Financial Advisory Chat Generator')
    parser.add_argument("--run_id", type=str, help="Optional run ID to use for this generation")
    parser.add_argument("--num", type=int, default=5, help="Number of conversations to generate")
...
async def main():
    ...
    try:
        ...
        # Load the financial advisory config
        config = load_config_from_file("configs/financial_advisory.py")
        ...
        # Run the generator
        logging.info(f"Starting financial advisory conversation generation")
