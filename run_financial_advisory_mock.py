#!/usr/bin/env python3
"""
Runner script for financial advisory use case with mock LLM.
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(description='Financial Advisory Chat Generator (Mock)')
...
async def main():
    ...
    try:
        ...
        # Load the financial advisory mock config
        config = load_config_from_file("configs/financial_advisory_mock.py")
        ...
        # Run the generator
        logging.info(f"Starting financial advisory conversation generation with mock LLM")
